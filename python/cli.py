...
def get_copy_to_lib_command(info):
    ...
    cmd += 'cp /usr/lib/libblosc.so.1.17.1                               /tmp/{repo}/lib/libblosc.so.1; '
    ...
    cmd += 'cp /usr/lib/x86_64-linux-gnu/libHalf.so.24.0.0               /tmp/{repo}/lib/libHalf.so.24; '
    ...
    cmd += 'cp /usr/lib/x86_64-linux-gnu/libsnappy.so.1.1.8              /tmp/{repo}/lib/libsnappy.so.1; '
    ...
    cmd += 'cp /usr/lib/x86_64-linux-gnu/libzstd.so.1.4.4                /tmp/{repo}/lib/libzstd.so.1.4.4; '
